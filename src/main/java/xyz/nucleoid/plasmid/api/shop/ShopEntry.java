...
public final class ShopEntry implements GuiElement {
    ...
    public static ShopEntry buyItem(ItemStack stack) {
        ...
        return new ShopEntry(icon).onBuy((player) -> player.getInventory().placeItemBackInInventory(stack.copy(), Prediction.PREDICTED));
    }
    ...
    public static ShopEntry buyItem(ItemStack stack, Cost cost) {
        ...
        return new ShopEntry(icon).onBuy((player) -> player.getInventory().placeItemBackInInventory(stack.copy(), Prediction.PREDICTED)).withCost(cost);
    }
